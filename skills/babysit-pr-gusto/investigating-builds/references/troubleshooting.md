...
```bash
# Script failing
${CLAUDE_SKILL_DIR}/investigating-builds/scripts/wait-for-build.js gusto payroll-building-blocks 123
...
```bash
${CLAUDE_SKILL_DIR}/investigating-builds/scripts/find-commit-builds.js gusto <commit-sha>
```
